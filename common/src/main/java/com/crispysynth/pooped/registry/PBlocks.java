...
public class PBlocks {
    ...
    public static final Supplier<Block> POOP_BRICK_STAIRS = registerBlock("poop_brick_stairs", () -> new com.crispysynth.pooped.block.StairBlock(POOP_BRICKS.get().defaultBlockState(), Block.Properties.of(Material.FROGSPAWN).strength(0.4F).sound(SoundType.HONEY_BLOCK)));
